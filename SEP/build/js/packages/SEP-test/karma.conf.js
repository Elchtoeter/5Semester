...
config.set({
  "singleRun": true,
  "autoWatch": false,
  "basePath": "C:\\Github\\5Semester\\SEP\\build\\js\\packages\\SEP-test\\node_modules",
  "files": [
    "C:\\Github\\5Semester\\SEP\\build\\js\\packages\\SEP-test\\adapter-browser.js"
  ],
  "frameworks": [
    "mocha"
  ],
...
;(function(config) {
    ...
    const handler = (percentage, message, ...args) => {
        ...
        msg = msg.replace(new RegExp("C:\\Github\\5Semester\\SEP\\build\\js", 'g'), '');;
        console.log(msg);
    };
