...
\hspace{-2cm}
  ...
  \begin{enumerate}
      \item [b)]
      \begin{itemize}
        \item $x_3  \Rightarrow  \Omega_0 = \frac{2\pi}{64}$ ist aus der Angabe ablesbar.
        \item $x_4 \Rightarrow \Omega_0 =\frac{9}{64}$ ist aus der Angabe ablesbar.
      \end{itemize}
      \item [c)]
      \begin{itemize}
      ...
      \item [d)]
        ...
        Periodische Signale aus 1a) sind Signale X3 und x6 

        Funktion ( implementiert in File leistung.m)

        Resultate siehe 1f) Tabelle
      \item[e)]
      Funktion ( implementiert in File energie.m)

      Resultate siehe 1f) Tabelle
      \item[f)] 
      \begin{tabular}{|r|c|c|}
        \hline
          Funktion &Mittlere Leistung & Energie\\
          \hline
          x1 & & 30.0000\\
          \hline
          x3 & 1.99222 & \\
...
\pagebreak
    ...
    \pagebreak
    \item[b)] Die Spitzen der Dreiecksfunktion sind bei 10 Harmonischen noch deutlich rundlich und werden bei 1000 eindeutig spitzer. Auch der Verlauf der Steigung ist flacher und ähnelt mehr einer Geraden.
\end{enumerate}
\hspace{-1.5cm}
\includegraphics{1_3.eps} 
\end{aufgabe}
