...
public class CodeGenerationTest extends CompilerTestCaseSupport {
	...
	@Test
	public void compareExpressions1() {
		init("program Test" + LF + //
				"  {" + LF + //
				"    void main() int[] x; {  " + LF + //
				"      x = new int[2];" + LF + //
	...
	@Test
	public void compareExpressions2() {
		init("program Test" + LF + //
				"  {" + LF + //
				"    void main() int[] x; {  " + LF + //
				"      x = new int[2];" + LF + //
	...
	@Test
	public void compareExpressions3() {
		init("program Test" + LF + //
				"  {" + LF + //
				"    void main() int[] x; {  " + LF + //
				"      x = new int[2];" + LF + //
				"      x[0] = 1;" + LF + //
				"      x[1] = 1;" + LF + //
				"      compare((x[0] + 10) * 20, (x[0] + 10) * 20) " + LF + //
				"        { print(-1); }" + LF + //
				"        { print(0); }" + LF + //
				"        { print(1); }" + LF + //
				"    }" + LF + //
