...
public class SimpleCodeGenerationTest extends CompilerTestCaseSupport {
	...
	public void compareNonInt1() {
		init("program Test {" + LF + //
				...
				"  }" + LF + //
				"}");
		expectError(3, 19, NO_INT_OP);
		parseAndVerify();
	}

	@Test
	public void compareNonInt2() {
		init("program Test {" + LF + //
				"  void main() {  " + LF + //
				"    compare('a', '1') " + LF + //
				"      { print(-1); }" + LF + //
				...
				"  }" + LF + //
				"}");
		expectError(3, 16, NO_INT_OP);
		parseAndVerify();
	}

	@Test
	public void compareNonInt3() {
		init("program Test {" + LF + //
				"  void main() {  " + LF + //
				"    compare('a', 'b') " + LF + //
				"      { print(-1); }" + LF + //
				...
				"}");
		expectError(3, 16, NO_INT_OP);
		// No second error expected because of recovering
		parseAndVerify();
	}
}
