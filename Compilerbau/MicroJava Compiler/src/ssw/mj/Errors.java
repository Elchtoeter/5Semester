...
public class Errors {
	...
	public enum Message {
		...
		DESIGN_FOLLOW("assignment, method call, increment (++) or decrement "
				+ "(--) expected"),
		INVALID_DECL("invalid global declaration"),
		INVALID_FACT("invalid start of factor: identifier, number, character "
				+ "constant, new or ( expected"),
		INVALID_STAT("invalid start of statement: identifier, if, while, do, "
				+ "break, return, read, print, '{' or ; expected"),
		...
		SWITCH_TYPE("switch labels must be of type int"),
